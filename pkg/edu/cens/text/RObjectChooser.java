...
public class RObjectChooser extends JPanel implements WindowListener
{
	 ...
	 *            title
	 */
	public RObjectChooser(String title, Window parentWindow)
	{
		super();
		initGUI();
		this.title = title;
	...
	public RObjectChooser(Window parentWindow)
	{
		...
		{
			{
				...
				this.setPreferredSize(new java.awt.Dimension(187, 47));
				{
					...
					titleLabel.setText("title");
					titleLabel
							.setPreferredSize(new java.awt.Dimension(187, 20));
				...
				}
				{
					...
					this.add(objectCombo, new AnchorConstraint(22, 1000, 1000,
							0, AnchorConstraint.ANCHOR_ABS,
							AnchorConstraint.ANCHOR_REL,
							AnchorConstraint.ANCHOR_REL,
							AnchorConstraint.ANCHOR_REL));
					objectCombo
							.setPreferredSize(new java.awt.Dimension(186, 19));
				}
			}
		}
		catch (Exception e)
